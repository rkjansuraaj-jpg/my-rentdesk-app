...
export default function StartRental() {
  ...
  async function handleCreateCustomer() {
    ...
    const record = await addCustomer({ name: newCustomer.name.trim(), mobile: newCustomer.mobile.trim(), address: newCustomer.address.trim(), idFront: newCustomer.idFront, idBack: newCustomer.idBack, notes: newCustomer.notes.trim() });
