...
import { LayoutDashboard, UserSearch, UserPlus2, Package, Wrench, ClipboardList, Undo2, ReceiptText, Hammer, BarChart3, Users } from "lucide-react";
...
export default function Sidebar() {
  return (
    <div style={{ width: 216, background: "#fff", borderRight: `1px solid ${COLORS.LINE}`, height: "100vh", flexShrink: 0, position: "sticky", top: 0 }}>
