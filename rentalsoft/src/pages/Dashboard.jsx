...
function ResetDataLink() {
  ...
  return (
    <button
      onClick={() => {
        if (window.confirm("This clears all products, machines, customers, orders, payments and maintenance records saved on this device, and cannot be undone. Continue?")) {
          resetAllData();
        }
      }}
      style={{ background: "none", border: "none", padding: 0, fontSize: 11.5, color: COLORS.INK_SOFT, textDecoration: "underline", cursor: "pointer" }}
    >
